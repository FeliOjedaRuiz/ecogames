...
import puzzleImage from "../../assets/images/puzzle2-3.png";

function Puzzle2Page3() {
    ...
    <Layout>
      ...
      <div className="bg-gradient-to-b from-white to-gray-200 w-full animate-slide1 p-1 md:p-4 drop-shadow-lg rounded-lg">
        <p className="font-extrabold md:text-2xl text-center text-rose-700">
          ¿Cómo crees que se pueden limitar las emisiones de los coches?
        </p>
      </div>
      <div
      ...
      >
        <p className="drop-shadow-md text-center text-sm leading-4 md:text-lg">
          Limitando la velocidad y manteniéndola constante.
        </p>
      </div>
      <div
        onClick={() => wrongClick()}
      ...
      >
        <p className="drop-shadow-md text-center text-sm leading-4 md:text-lg">
          Conduciendo más rápido para llegar antes y que el viaje dure menos.
        </p>
      </div>
