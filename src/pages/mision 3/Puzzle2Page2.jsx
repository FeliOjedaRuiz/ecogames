...
import puzzleImage from "../../assets/images/puzzle2-2.png";

function Puzzle2Page2() {
    ...
    <Layout>
      ...
      <div className="bg-gradient-to-b from-white to-gray-200 w-full animate-slide1 p-1 md:p-4 drop-shadow-lg rounded-lg">
        <p className="font-extrabold md:text-2xl text-center text-rose-700">
          ¿Qué medio de transporte crees que tienen menores emisiones por
          viajero en la corta distancia?
        </p>
      </div>
      ...
      >
        <p className="drop-shadow-md text-center text-3xl">
          El patín eléctrico
        </p>
      </div>
      <div
      ...
      >
        <p className="drop-shadow-md text-center text-3xl">El metro</p>
      </div>
