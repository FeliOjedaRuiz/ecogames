  ...
  return (
    <Layout>
      <div className="bg-gradient-to-b from-white to-gray-200 w-screen relative animate-slide1 -left-10 px-4 py-2 drop-shadow-lg rounded-lg">
        <p className="text-teal-700 drop-shadow-lg ml-7 leading-5 text-sm md:text-lg">
      ...
      <div
        onClick={() => wrongClick()}
        className="bg-gradient-to-b from-lime-500 to-lime-700  p-2 animate-slide3 rounded-lg shadow-lg font-bold text-white leading-4 md:leading-5"
      >
        <span className="drop-shadow-md text-xs md:text-lg">
      ...
      <div
        ...
        className="bg-gradient-to-b from-cyan-600 to-cyan-800  p-2 animate-slide4 rounded-lg shadow-lg font-bold text-white leading-4 md:leading-5"
      >
        <span className="drop-shadow-md text-xs md:text-lg">
