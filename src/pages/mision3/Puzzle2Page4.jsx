...
import puzzleImage from "../../assets/images/puzzle2-4.png";

function Puzzle2Page4() {
    ...
    <Layout>
      ...
      <div className="bg-gradient-to-b from-white to-gray-200 w-full animate-slide1 p-1 md:p-3 drop-shadow-lg rounded-lg">
        <p className="font-extrabold  md:text-lg text-center leading-5 text-rose-700">
          ¿Cuál es el medio de transporte más sostenible en el día a día de la
          corta distancia en ciudad o pueblos?
        </p>
      </div>
      <div
