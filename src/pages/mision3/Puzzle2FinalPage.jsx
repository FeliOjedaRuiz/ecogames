...
function Puzzle2FinalPage() {
  ...
  const { handleUnlockLevel3 } = useContext(ProgressContext);
  ...
  return (
    <Layout>
      ...
      <div className=" animate-slide-r-2 px-6 py-3 drop-shadow-lg rounded-lg">
        <p className="text-white drop-shadow-lg text-center p-5 font-bold text-3xl md:text-5xl">
          ¡Felicitaciones!
        </p>
      </div>
      <div
        ...
        >
          ...
          <div className="text-center font-bold text-black mb-6 ">
            ...
            <p className=" md:text-3xl text-yellow-600">
              Has superado tu segunda misión.
            </p>
            <br />
            <p className="md:text-xl text-yellow-900">
              Te has convertido en un experto de movilidad sostenible.
              <br />
              Pero aún te queda un desafío... <br /> ¿Estas preparado?
            </p>
          </div>
...
export default Puzzle2FinalPage;
