...
import puzzleImage from "../../assets/images/puzzle2-5.png";

function Puzzle2Page5() {
    ...
    <Layout>
      ...
      <div className="bg-gradient-to-b from-white to-gray-200 w-full animate-slide1 p-1 md:p-4 drop-shadow-lg rounded-lg">
        <p className="font-extrabold md:text-2xl leading-5 text-center text-rose-700">
          ¿Cuál es el medio de transporte más sostenible en el fin de semana
          para ir visitar a un amigo a un familiar?
        </p>
      </div>
      ...
      >
        <p className="drop-shadow-md text-center md:text-3xl leading-6">Avión</p>
      </div>
      <div
      ...
      >
        <p className="drop-shadow-md text-center md:text-3xl leading-6">
          Bicicleta
        </p>
      </div>
