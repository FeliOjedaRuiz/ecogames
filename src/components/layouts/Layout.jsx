  ...
  return (
    <div className="relative">
      ...
      <div className="landscape:hidden">
        <div className="w-screen h-screen flex flex-col justify-evenly absolute -top-16 pt-16 px-5 bg-gradient-to-t from-white via-teal-400 to-cyan-800 overflow-hidden">
          {children}
        </div>
      </div>
    </div>
