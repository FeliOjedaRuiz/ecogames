...
import QuizGamePage1 from "./pages/mision1/QuizGamePage1";
import QuizGamePage2 from "./pages/mision1/QuizGamePage2";
import QuizGamePage3 from "./pages/mision1/QuizGamePage3";
import GameSelectionPage from "./pages/GameSelectionPage";
import Mision1Presentation from "./pages/mision1/Mision1Presentation";
import ProgressStore from "./contexts/ProgressStore";
import Mision2Presentation from "./pages/mision2/Mision2Presentation";
import Mision2IntroPage1 from "./pages/mision2/Mision2IntroPage1";
import Mision2IntroPage2 from "./pages/mision2/Mision2IntroPage2";
import Mision2IntroPage3 from "./pages/mision2/Mision2IntroPage3";
import Puzzle1Page1 from "./pages/mision2/Puzzle1Page1";
import Puzzle1Page2 from "./pages/mision2/Puzzle1Page2";
import Puzzle1Page3 from "./pages/mision2/Puzzle1Page3";
import Puzzle1Page4 from "./pages/mision2/Puzzle1Page4";
import Puzzle1Page5 from "./pages/mision2/Puzzle1Page5";
import Puzzle1Page6 from "./pages/mision2/Puzzle1Page6";
import Puzzle1Page7 from "./pages/mision2/Puzzle1Page7";
import Puzzle1Page8 from "./pages/mision2/Puzzle1Page8";
import Puzzle1FinalPage from "./pages/mision2/Puzzle1FinalPage";
import Mision3Presentation from "./pages/mision3/Mision3Presentation";
import Mision3IntroPage1 from "./pages/mision3/Mision3IntroPage1";
import Mision3IntroPage2 from "./pages/mision3/Mision3IntroPage2";
import Mision3IntroPage3 from "./pages/mision3/Mision3IntroPage3";
import Puzzle2Page1 from './pages/mision3/Puzzle2Page1';
import Puzzle2Page2 from "./pages/mision3/Puzzle2Page2";
import Puzzle2Page3 from "./pages/mision3/Puzzle2Page3";
import Puzzle2Page4 from "./pages/mision3/Puzzle2Page4";
import Puzzle2Page5 from "./pages/mision3/Puzzle2Page5";
import Puzzle2Page6 from "./pages/mision3/Puzzle2Page6";
import Puzzle2Page7 from "./pages/mision3/Puzzle2Page7";
import Puzzle2Page8 from "./pages/mision3/Puzzle2Page8";
import Puzzle2FinalPage from './pages/mision3/Puzzle2FinalPage';
