function Layout({ children }) {
  return (
    ...
    <div className="portrait:hidden p-10 h-screen flex flex-col justify-evenly bg-gradient-to-t from-white via-teal-400 to-cyan-800">
      ...
      <div className="w-screen h-screen flex flex-col justify-evenly absolute -top-16 pt-16 pb-14 px-5 bg-gradient-to-t from-white via-teal-400 to-cyan-800 overflow-hidden">
              {children}
      </div>
